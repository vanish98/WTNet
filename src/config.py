...
parser = argparse.ArgumentParser(description='WTNet')
...
parser.add_argument("--num_heads",type=int, default='8',
                    help="transformer head number,BERT and GPT is 8")
parser.add_argument("--num_transformer_layers", type=int, default='4',
                    help="transformer layer number,generally is 4-12")
parser.add_argument("--num_transformer_hiddens", type=int, default='128',
                    help="transformer hidden number 128-512")
parser.add_argument("--dropout", type=float, default='0.1',
                    help="transformer dropout")
parser.add_argument("--windows_size",type=int, default=5,
                    help="history temporal graph size ")

parser.add_argument("--work_dir",type=str, default='transformer',
                    help="work dir")
parser.add_argument("--parameter_id",type=str, default="0",
