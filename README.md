...
```
ICEWS18和 GDELT 不需要参数time_encoding_independent 
number of layers for ICEWS18 and GDELT to 6, and 4 for WIKI and YAGO.
other datasets lr is 5𝑒 −4
length  ICEWS18,GDELT,WIKl, and YAGO as 25,15,10,and 8
### Evaluate models
